# FastAPI 
## [🎥 Playlist](https://www.youtube.com/watch?v=lXx-_1r0Uss)
...
universal data format-> can be understood by any programming language say java, python php  
...
Fast to code and Run API -> core philiosophy 
uses Python

---

single database connects to variousfront end using API.
ML- ML model is trained on a lot of data- 
## async support : ASGI
...
manages how your API receives req and sends back request  
```
FastAPI  
   ↓  
Starlette  
